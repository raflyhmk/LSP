 <footer>
    <div class="container mt-3">
      <div class="row">
        <div class="col-sm-12 col-md-4 mb-3">
          <h3 class="fw-bold text-capitalize">MediPrime</h3>
        ...
        <div class="col-sm-12 col-md-2 offset-md-1">
          ...
          <p class="listProduk fw-light"><a href="#">alat kesehatan</a></p>
          <p class="listProduk fw-light"><a href="#">review</a></p>
    ...
    <div class="CP-footer d-flex justify-content-center mt-3">
      <h5>Copyright © 2023 All rights reserved by MediPrime</h5>
    </div>
  </footer>
  <!-- end footer -->